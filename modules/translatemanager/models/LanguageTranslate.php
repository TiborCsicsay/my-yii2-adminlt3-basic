...
namespace app\modules\translatemanager\models;
...
class LanguageTranslate extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id'], 'integer'],
            [['id'], 'exist', 'targetClass' => '\app\modules\translatemanager\models\LanguageSource'],
            [['language'], 'exist', 'targetClass' => '\app\modules\translatemanager\models\Language', 'targetAttribute' => 'language_id'],
            [['translation'], 'string'],
